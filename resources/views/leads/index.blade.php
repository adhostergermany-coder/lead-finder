        ...
        <div class="grid grid-cols-1 md:grid-cols-6 gap-4 mt-4">
            ...
            <div>
                ...
                <select name="filter_has_email" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" onchange="this.form.submit()">
                    <option value="">Any</option>
                    <option value="yes" {{ ($filters['filter_has_email'] ?? '') === 'yes' ? 'selected' : '' }}>Yes</option>
                    <option value="no" {{ ($filters['filter_has_email'] ?? '') === 'no' ? 'selected' : '' }}>No</option>
                </select>
            </div>
            <div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                ...
                                @if($lead->phone)
                                    <div class="mt-1 flex items-center gap-1">
                                        ...
                                        <span class="text-gray-700 text-xs">{{ $lead->phone }}</span>
                                        <button onclick="copyText({{ json_encode($lead->phone) }})" 
