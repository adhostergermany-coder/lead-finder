...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Lead Finder'); ?></title>
...
<body class="bg-gray-100 min-h-screen">
    ...
    <nav class="bg-indigo-600 text-white shadow-lg">
        <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
            <a href="<?php echo e(route('leads.index')); ?>" class="text-xl font-bold tracking-tight">Lead Finder</a>
...
<?php /**PATH D:\Project\Lead data\lead-finder\resources\views/layouts/app.blade.php ENDPATH**/ ?>